...
const AREAS = [
  {
    ...
    nome: "Proatividade",
    perguntas: [
      "Você toma a iniciativa para iniciar novos projetos ou tarefas?",
      "Você age de forma antecipada para resolver problemas antes que eles surjam?",
      "Você busca oportunidades de aprendizado e desenvolvimento pessoal?",
      "Você propõe soluções criativas para melhorar processos e eficiência?",
    ],
  },
  {
    id: "autoconfianca",
    nome: "Autoconfiança",
    perguntas: [
      "Você se sente confiante em suas habilidades para enfrentar desafios e tomar decisões difíceis?",
      "Você expressa suas ideias e opiniões com clareza e convicção em discussões ou reuniões?",
      "Você confia na sua capacidade de influenciar e liderar outras pessoas?",
      "Você mantém a confiança em suas decisões, mesmo quando enfrenta críticas ou oposição?",
    ],
  },
  {
    id: "gestao_tempo",
    ...
    perguntas: [
      "Você planeja suas atividades diárias e define prioridades?",
      "Você consegue manter o foco em suas tarefas mesmo com distrações ao redor?",
      "Você evita procrastinar e prioriza suas responsabilidades?",
      "Você utiliza ferramentas de gestão de tempo, como agendas e listas de tarefas?",
    ],
  },
  {
    id: "flexibilidade",
    nome: "Flexibilidade",
    perguntas: [
      "Você se adapta facilmente a mudanças e novas situações?",
      "Você está disposto a aprender novas habilidades e assumir diferentes responsabilidades?",
      "Você lida bem com imprevistos e pressões no ambiente de trabalho?",
      "Você ajusta suas prioridades e planos para atender às demandas do trabalho?",
    ],
  },
  {
    ...
    perguntas: [
      "Você reconhece e gerencia bem suas próprias emoções no ambiente de trabalho?",
      "Você demonstra empatia e compreensão em relação às emoções dos seus colegas?",
      "Você lida de maneira eficaz com situações de conflito e estresse?",
      "Você mantém uma atitude positiva e motivadora, mesmo em situações desafiadoras?",
    ],
  },
];
...
const NIVEIS = [
  { min: 0, max: 30, nome: "Início da Jornada", descricao: "O colaborador está dando seus primeiros passos no desenvolvimento dessas competências. Recomenda-se um plano de desenvolvimento estruturado com acompanhamento frequente.", cor: "#ef4444" },
  { min: 31, max: 45, nome: "Em Desenvolvimento", descricao: "O colaborador demonstra progresso consistente, mas ainda há espaço significativo para crescimento. Investir em treinamentos específicos e mentoria acelerará o desenvolvimento.", cor: "#f59e0b" },
  { min: 46, max: 60, nome: "Alto Desempenho", descricao: "O colaborador apresenta maturidade comportamental elevada. Pode atuar como referência para a equipe e se beneficia de desafios que ampliem ainda mais seu potencial.", cor: "#10b981" },
];
...
export default function ComportamentalPage() {
  ...
  const diagnosticoCompleto = AREAS.every(
    (a) => Object.keys(respostas[a.id] || {}).length === 4
  );
  ...
  const gerarPDF = () => {
    ...
    <div class="cover">
      <div class="cover-logo"><span class="cover-logo-text">RESPONSA</span></div>
      <div class="cover-center">
        <div class="cover-badge">Diagnóstico de Atendimento</div>
        <div class="cover-title">Avaliação<br/>Comportamental</div>
        <div class="cover-sub">Diagnóstico de Competências Comportamentais</div>
      ...
      <div class="cover-footer">Diagnóstico Comportamental · Gerado pela Plataforma RESPONSA · Confidencial</div>
    </div>
    ...
    <div class="page">
      ...
      <div style="margin-top:48px;text-align:center;padding:20px;background:#f8fafc;border-radius:12px;border:1px solid #e2e8f0;">
        <p style="font-size:12px;color:#94a3b8;font-weight:600;">
          Relatório gerado pela Plataforma <strong style="color:#064384;">RESPONSA</strong> · Diagnóstico Comportamental<br/>
      ...
      <main className="flex-1 overflow-y-auto flex flex-col h-full">
        <header className="bg-white px-8 py-5 border-b border-slate-200 shadow-sm sticky top-0 z-10 flex items-center gap-4">
          <div className="size-12 bg-purple-50 text-purple-600 rounded-xl flex items-center justify-center shrink-0">
            <span className="material-symbols-outlined text-[26px]" style={{ fontVariationSettings: "'FILL' 1" }}>psychology_alt</span>
          </div>
          <div>
            <h2 className="text-xl font-black text-[#064384]">Atendimento Comportamental</h2>
            <p className="text-sm font-bold text-slate-500">Diagnóstico de Competências Comportamentais</p>
          </div>
        </header>
              ...
              <div key={s.id} className="flex items-center gap-1 shrink-0">
                <button
                  ...
                  className={`flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-bold transition-all ${
                    s.id === step
                      ? "bg-[#064384] text-white"
                      : i < stepIdx
                        ? "text-[#064384] hover:bg-blue-50 cursor-pointer"
        ...
        <div className="flex-1 p-8 max-w-4xl mx-auto w-full">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="sm:col-span-2 flex flex-col gap-1.5">
                  ...
                  <textarea
                    rows={3}
                    placeholder="Descreva os principais desafios da empresa..."
                    value={ficha.desafiosAtuais}
              ...
              <div className="mt-6 flex justify-end">
                <button
                  onClick={() => { if (!ficha.razaoSocial || !ficha.nomeContato) { alert("Preencha Razão Social e Nome do Contato."); return; } setStep("diagnostico"); }}
          ...
          {step === "diagnostico" && (
            <div className="space-y-8">
                  ...
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 font-medium">
                        {Object.keys(respostas[area.id] || {}).length}/4 respondidas
                        {Object.keys(respostas[area.id] || {}).length === 4 && " ✓"}
                      </p>
                    </div>
                    <div className="ml-auto font-black text-[#064384] text-lg">
                      {calcularSubtotal(area.id)}/12
                    </div>
                  </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                          {OPCOES.map((op) => (
                            <button
                              key={op.valor}
                              onClick={() => {
                                const atual = respostas[area.id] || {};
                                setRespostas({ ...respostas, [area.id]: { ...atual, [pi]: op.valor } });
                              }}
                              className={`flex-1 py-2.5 px-3 rounded-xl border text-xs font-black transition-all ${
                                (respostas[area.id] || {})[pi] === op.valor
                                  ? op.valor === 1
              ...
              <div className="flex items-center justify-between">
                <button onClick={() => setStep("ficha")} className="flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-[#064384] transition-colors">
                  <span className="material-symbols-outlined text-[18px]">arrow_back</span> Voltar
                </button>
                <button
                  onClick={() => { if (!diagnosticoCompleto) { alert("Responda todas as perguntas antes de continuar."); return; } setStep("resultado"); }}
            ...
            return (
              <div className="space-y-6">
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 text-center">
                  ...
                  <div className="inline-block px-6 py-3 rounded-full text-white font-black text-xl" style={{ background: nivel.cor }}>
                    {nivel.nome}
                  </div>
                    ...
                    return (
                      <div key={area.id} className="mb-4">
                        <div className="flex justify-between text-sm font-bold mb-1">
                          <span className="text-slate-700">{area.nome}</span>
                          <span className="text-slate-500">{sub}/12 ({pct}%)</span>
                        </div>
          ...
          {step === "melhoria" && (
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <button onClick={() => setStep("resultado")} className="flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-[#064384] transition-colors">
                  <span className="material-symbols-outlined text-[18px]">arrow_back</span> Voltar
                </button>
                <button onClick={() => setStep("plano")} className="flex items-center gap-2 h-12 px-8 bg-[#064384] text-white font-black rounded-xl hover:bg-blue-900 transition-all shadow-md">
                  Plano de Ação
          ...
          {step === "plano" && (
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <button onClick={() => setStep("melhoria")} className="flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-[#064384] transition-colors">
                  <span className="material-symbols-outlined text-[18px]">arrow_back</span> Voltar
                </button>
                <button onClick={() => setStep("relatorio")} className="flex items-center gap-2 h-12 px-8 bg-[#064384] text-white font-black rounded-xl hover:bg-blue-900 transition-all shadow-md">
                  Gerar Relatório
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 text-center">
                  ...
                  <p className="text-slate-600 font-medium mb-6">
                    {ficha.razaoSocial} · {total}/60 pontos · {nivel.nome}
                  </p>
                  <button
                    onClick={gerarPDF}
                    className="flex items-center justify-center gap-2 h-14 px-10 bg-[#064384] text-white font-black rounded-xl hover:bg-blue-900 transition-all shadow-lg mx-auto"
                  >
